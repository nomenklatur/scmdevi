  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('pbbcontroller') ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
          </div>
          <div class="card-body">

            <form action="<?php echo site_url('pbbcontroller/add') ?>" method="post" enctype="multipart/form-data" >
