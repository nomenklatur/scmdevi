  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('pccontroller') ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
          </div>
          <div class="card-body">

            <form action="<?php echo site_url('pccontroller/add') ?>" method="post" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('tglmasuk') ? 'is-invalid':'' ?>"
                 type="date" name="tglmasuk" placeholder="Tanggal Masuk" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('jlhcake') ? 'is-invalid':'' ?>"
                 type="text" name="jlhcake" placeholder="Jumlah Cake" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('stkcake') ? 'is-invalid':'' ?>"
                 type="text" name="stkcake" placeholder="Stok Cake" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('terjual') ? 'is-invalid':'' ?>"
                 type="text" name="terjual" placeholder="Terjual" />
                <div class="invalid-feedback">
