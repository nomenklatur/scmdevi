            ...
            <!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
                 type="text" name="nama" placeholder="" value="<?php echo $produk->nama ?>" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('jlhcake') ? 'is-invalid':'' ?>"
                 type="text" name="jlhcake" min="0" placeholder="" value="<?php echo $produk->jlhcake ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"
                 type="text" name="harga" min="0" placeholder="" value="<?php echo $produk->harga ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('total') ? 'is-invalid':'' ?>"
                 type="text" name="total" min="0" placeholder="" value="<?php echo $produk->total ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('tglorder') ? 'is-invalid':'' ?>"
                 type="date" name="tglorder" min="0" placeholder="" value="<?php echo $produk->tglorder ?>" />
                <div class="invalid-feedback">
