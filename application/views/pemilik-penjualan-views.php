...
<div class="page-content p-5" id="content">
  ...
  <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo base_url('as_pemilik_2/tambah') ?>"><i class="fa fa-plus"></i> Tambahkan</a>
          </div>
          <div class="card-body">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo site_url('as_pemilik_2/edit/'.$product->kode) ?>"
                       class="btn btn-small btn-primary"><i class="fa fa-edit"></i> Edit</a>
                      <a 
                       href="<?php echo site_url('as_pemilik_2/delete/'.$product->kode) ?>" class="btn btn-small btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
  ...
  <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo base_url('as_pemilik_2/tambah2') ?>"><i class="fa fa-plus"></i> Tambahkan</a>
          </div>
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td >
                      <?php echo $produks->kode ?>
                    </td>
                    <td>
                      <?php echo $produks->nama ?>
                    </td>
                    <td>
                      <?php echo $produks->jlhcake ?>
                    </td>
                    <td>
                      <?php echo $produks->harga ?>
                    </td>
                    <td>
                      <?php echo $produks->total ?>
                    </td>
                    <td>
                      <?php echo $produks->tglorder ?>
                    </td>
                    <td>
                      <?php echo $produks->status ?>
                    </td>
                    <td>
                      <a href="<?php echo site_url('as_pemilik_2/edit2/'.$produks->kode) ?>"
                       class="btn btn-small btn-primary"><i class="fa fa-edit"></i></a>
                      <a 
                       href="<?php echo site_url('as_pemilik_2/delete2/'.$produks->kode) ?>" class="btn btn-small btn-danger"><i class="fa fa-trash"></i></a>
                       <a 
                       href="<?php echo site_url('as_pemilik_2/kehabisan/'.$produks->kode) ?>" class="btn btn-small btn-warning"><i class="fa fa-minus-circle"></i></a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
