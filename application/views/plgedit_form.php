  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <a href="<?php echo site_url('plgcontroller') ?>"><i class="fa fa-arrow-left"></i>
              Kembali</a>
          </div>
          <div class="card-body">
            ...
            <!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nohp') ? 'is-invalid':'' ?>"
                 type="text" name="nohp" min="0" placeholder="Nomor Handphone" value="<?php echo $product->nohp ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>"
                 type="text" name="alamat" min="0" placeholder="alamat" value="<?php echo $product->alamat ?>" />
                <div class="invalid-feedback">
