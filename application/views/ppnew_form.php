  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('ppcontroller') ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
          </div>
          <div class="card-body">

            <form action="<?php echo site_url('ppcontroller/add') ?>" method="post" enctype="multipart/form-data" >
            ...
            <input class="form-control <?php echo form_error('nama_bahan') ? 'is-invalid':'' ?>"
              ...
              <div class="form-group">
                <label for="hasil">Stok*</label>
                <input class="form-control <?php echo form_error('stok') ? 'is-invalid':'' ?>"
                 type="text" name="stok" placeholder="Stok Tersedia" />
                <div class="invalid-feedback">
