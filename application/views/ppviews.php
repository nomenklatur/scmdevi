...
<div class="page-content p-5" id="content">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center">Stok Bahan Baku</h3>
      </div>
    </div>
  </div>
  <!-- Toggle button -->
  <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo base_url('ppcontroller/tambah') ?>"><i class="fa fa-plus"></i> Tambahkan</a>
          </div>
          <div class="card-body">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo $product->nama_bahan ?>
                    </td>
                    <td>
                      <?php echo $product->tanggal_produksi ?>
                    </td>
                    <td>
                      <?php echo $product->tanggal_selesai ?>
                    </td>
                    <td>
                      <?php echo $product->hasil ?>
                    </td>
                    <td>
                      <?php echo $product->Stok ?>
                    </td>
                    <td width="250">
                      <a href="<?php echo site_url('ppcontroller/detail/'.$product->kode) ?>"
                       class="btn btn-small btn-success"><i class="fa fa-info-circle"></i> Detail</a>
                      <a 
                       href="<?php echo site_url('ppcontroller/delete/'.$product->kode) ?>" class="btn btn-small btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
