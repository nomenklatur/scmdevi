  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <a href="<?php echo site_url('suppcontroller') ?>"><i class="fa fa-arrow-left"></i>
              Kembali</a>
          </div>
          <div class="card-body">
            ...
            <!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
              ...
              <div class="form-group">
                ...
                <input disabled class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
                 type="text" name="nama" min="0" value="<?php echo $product->nama ?>" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input disabled class="form-control <?php echo form_error('email') ? 'is-invalid':'' ?>"
                 type="text" name="email" min="0" placeholder="Tanggal selesai" value="<?php echo $product->email ?>" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                <label for="nohp">Nomor Telefon</label>
                <input disabled class="form-control <?php echo form_error('nohp') ? 'is-invalid':'' ?>"
                 type="text" name="nohp" min="0" placeholder="nohp Produksi" value="<?php echo $product->nohp ?>" />
                <div class="invalid-feedback">
