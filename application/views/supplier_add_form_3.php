  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('as_supplier_3') ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
          </div>
          <div class="card-body">

            <form action="<?php echo site_url('as_supplier_3/add') ?>" method="post" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nohp') ? 'is-invalid':'' ?>"
                 type="text" name="nohp" placeholder="No. Telepon" />
                <div class="invalid-feedback">
