  ...
  <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <a href="<?php echo site_url('as_supplier_1') ?>"><i class="fa fa-arrow-left"></i>
              Kembali</a>
          </div>
          <div class="card-body">
            ...
            <!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('suppliers') ? 'is-invalid':'' ?>"
                 type="text" name="suppliers" placeholder="Supplier Bahan" value="<?php echo $product->suppliers ?>" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('bahanbaku') ? 'is-invalid':'' ?>"
                 type="text" name="bahanbaku" min="0" placeholder="bahan baku" value="<?php echo $product->bahanbaku ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('jumlah') ? 'is-invalid':'' ?>"
                 type="text" name="jumlah" min="0" placeholder="jumlah" value="<?php echo $product->jumlah ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"
                 type="text" name="harga" min="0" placeholder="Harga" value="<?php echo $product->harga ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('total') ? 'is-invalid':'' ?>"
                 type="text" name="total" min="0" placeholder="total" value="<?php echo $product->total ?>" />
                <div class="invalid-feedback">
               ...
               <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('tanggalorder') ? 'is-invalid':'' ?>"
                 type="date" name="tanggalorder" min="0" placeholder="tanggal order" value="<?php echo $product->tanggalorder ?>" />
                <div class="invalid-feedback">
