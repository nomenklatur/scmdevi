...
<div class="page-content p-5" id="content">
  ...
  <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo base_url('as_supplier_1/tambah') ?>"><i class="fa fa-plus"></i> Tambahkan</a>
          </div>
          <div class="card-body">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo site_url('as_supplier_1/edit/'.$product->kode) ?>"
                       class="btn btn-small btn-primary"><i class="fa fa-edit"></i> Edit</a>
                      <a 
                       href="<?php echo site_url('as_supplier_1/delete/'.$product->kode) ?>" class="btn btn-small btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
